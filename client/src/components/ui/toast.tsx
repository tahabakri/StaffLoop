...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 right-4 z-[200] flex flex-col items-end max-h-screen w-full max-w-xs pointer-events-auto",
      className
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariants({ variant }), "pointer-events-auto cursor-pointer", className)}
      {...props}
    />
  )
})
